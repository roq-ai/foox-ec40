...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Application.create': { roles: ['owner', 'recruiter'], key: 'job_application', tenantPath: [], userPath: [] },
  'Shortlisted Freelancer.update': {
    roles: ['owner', 'recruiter'],
    key: 'shortlisted_freelancer',
    tenantPath: [],
    userPath: [],
  },
  'Approved Freelancer.update': {
    roles: ['owner', 'recruiter'],
    key: 'approved_freelancer',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'recruiter'];
