...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    },
    {
      ...
      path: '/freelancer-profiles',
      entity: 'freelancer_profile',
      service: AccessServiceEnum.PROJECT,
      icon: FiUser,
    },
    { name: 'Hirings', path: '/hirings', entity: 'hiring', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Jobs', path: '/jobs', entity: 'job', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
    { name: 'Worklogs', path: '/worklogs', entity: 'worklog', service: AccessServiceEnum.PROJECT, icon: FiClock },
